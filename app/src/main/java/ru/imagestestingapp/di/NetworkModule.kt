...
import ru.imagestestingapp.BuildConfig
import ru.imagestesting.data.network.interceptor.ErrorResponseInterceptor
import ru.imagestesting.data.network.interceptor.HeaderInterceptor
...
internal val networkModule = module {
    ...
    single(named("AuthRetrofit")) {
        get<Retrofit.Builder>(named("AuthBuilder"))
            .baseUrl(ru.imagestesting.data.BuildConfig.API_ENDPOINT).build()
    }
